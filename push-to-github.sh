...
# 推送到远程仓库：https://github.com/lujian1997524/tianhui.git
...
git remote add origin https://github.com/lujian1997524/tianhui.git
...
if git push -u origin main; then
    echo "✅ 成功推送到GitHub仓库！"
    echo "🔗 仓库地址: https://github.com/lujian1997524/tianhui.git"
    echo ""
    echo "📊 推送统计："
    echo "   - 项目文件已全量推送"
